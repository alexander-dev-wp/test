<?php
/**
 * Template Name: Laminate Flooring Page
 */
get_header(); ?>
    <main>
        <section id="top" class="product__hero-section">
            <div class="product__hero-image">
                ...
                <img class="product__hero-vector" src="<?php echo IMAGE_ASSETS . 'product-vector.svg' ?>" alt="product-vector.svg">
            </div>
        ...
        <?php if ($text = get_field('laminate_text')): ?>
            <section class="laminate__text-section">
                <div class="grid-container">
        ...
        <div class="page__anchor-wrapper laminate__anchor">
