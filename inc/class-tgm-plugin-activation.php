...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function install_plugins_page() {
			...
			if ( ( in_array( $plugin_table->current_action(), array( 'tgmpa-bulk-install', 'tgmpa-bulk-update', 'tgmpa-bulk-install-activate' ) ) && $plugin_table->process_bulk_actions() ) || $this->do_plugin_install() ) {
				return;
			}
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		public function get_bulk_actions() {
			...
			if ( 'update' !== $this->view_context && 'activate' !== $this->view_context ) {
				if ( current_user_can( 'install_plugins' ) ) {
					...
					$actions['tgmpa-bulk-install-activate'] = __( 'Install & Activate', 'tgmpa' );
				}
			}
		...
		public function process_bulk_actions() {
			...
			if ( in_array( $this->current_action(), array( 'tgmpa-bulk-install', 'tgmpa-bulk-update', 'tgmpa-bulk-install-activate' ) ) ) {
				...
				if ( 'tgmpa-bulk-update' === $this->current_action() ) {
					$install_type = 'update';
				} elseif ( 'tgmpa-bulk-install-activate' === $this->current_action() ) {
