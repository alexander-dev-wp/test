            ...
            <?php while ($slider->have_posts()) : $slider->the_post(); ?>
                <div class="slick-slide home-slide">
                    ...
                    <div class="home-slide__inner rel-wrap">
                        <?php echo wp_get_attachment_image(get_post_thumbnail_id(), 'full_hd', false, array('class' => 'stretched-img home-slide__bg skip-lazy')); ?>
                        <?php $bg_video_url = get_post_meta(get_the_ID(), 'slide_video_bg', true); ?>
                        <?php if (get_post_format() == 'video' && $bg_video_url): ?>
                            <div class="video-holder show-for-large"
                                ...
                                if ($file_info['ext']): ?>
                                    <video src="<?php echo $bg_video_url; ?>" autoplay preload="none" playsinline
                        ...
                        <div class="grid-container ">
                            <div class="grid-x grid-padding-x align-top home-slide__caption">
                                <div class="cell hero__wrapper">
                                    ...
                                    <?php $consultation_button = get_field('consultation_link');
                                    $products_button = get_field('products_link');
                                    if ($products_button || $consultation_button):?>
                                        <div class="hero__button-wrapper">
                                            <?php if ($consultation_button): ?>
                                                <a href="<?php echo $consultation_button["url"] ?>"
                                                   class="hero__consultation-button button__link">
                                                    <?php if ($icon = get_field('consultation_icon')): ?>
                                                        <?php echo wp_get_attachment_image($icon["id"], 'full') ?>
                                                    <?php endif; ?>
                                                    <?php echo $consultation_button["title"] ?>
                                                </a>
                                            <?php endif; ?>
                                            <?php if ($products_button): ?>
                                                <a href="<?php echo $products_button["url"] ?>"
                                                   class="hero__products-button button__link">
                                                    <?php if ($icon = get_field('products_icon')): ?>
                                                        <?php echo wp_get_attachment_image($icon["id"], 'full') ?>
                                                    <?php endif; ?>
                                                    <?php echo $products_button["title"] ?>
                                                </a>
                                            <?php endif; ?>
                                        </div>
                                    <?php endif; ?>
                        ...
                        <img src="<?php echo IMAGE_ASSETS . 'hero-vector.svg' ?>" class="hero__vector" alt="product vector">
                    </div>
